...
export default function HomeDashboard({
  ...
  const closeCountdown = useMemo(() => {
    ...
    const ms = kickoffInstantMs(heroMatch.kickoff);
    ...
    <div className="home-dash">
      ...
      <footer className="home-dash-footer" aria-label="Inscritos quiniela y parlay">
        <section className="home-dash-pool">
          ...
          <p className="home-dash-pool__bolsa">
            💰 Bolsa Quiniela: $
            {QUINIELA_INSCRITOS.reduce((sum, row) => sum + row.amount, 0).toLocaleString('es-MX')} MXN
          </p>
        </section>
        <section className="home-dash-pool">
