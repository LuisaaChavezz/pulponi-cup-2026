...
values
  ...
  ('enrachado', 'Enrachado', 'Tres ganadores seguidos. La racha empieza a sentirse real.', '🔥', 'Acertar el ganador en 3 partidos consecutivos.', 'streak_min', 3, 4, true),
  ('imparable', 'Imparable', 'Cinco ganadores seguidos. Modo bestia.', '🔥🔥', 'Acertar el ganador en 5 partidos consecutivos.', 'streak_min', 5, 5, true),
  ...
  ('el-elegido', 'El Elegido', 'El pulpo eligió al mejor. Defiéndelo o piérdelo.', '🔱', 'Ser elegido por el pulpo como el mejor del ranking.', 'manual', 0, 8, true),
  ('pick-salvaje', 'Pick Salvaje', 'Acertaste lo que casi nadie se atrevió a poner.', '⚡', 'Acertar un marcador elegido por menos del 5% de usuarios.', 'risky_exact', 1, 9, true),
  ('pulpo-legendario', 'Pulpo Legendario', 'Índice Pulpo 90+. Nivel supremo.', '🐙', 'Alcanzar Índice Pulpo 90+.', 'pulpo_index_min', 90, 10, true),
